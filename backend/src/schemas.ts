...
export const captchaToken = z.string().min(1, "Complete the security check").optional();
export const loginSchema = z.object({ email, password: z.string().min(1), captchaToken });
export const customerRegistration = z.object({ fullName: z.string().min(2), email, phone: z.string().min(7), password, captchaToken });
