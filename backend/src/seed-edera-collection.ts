...
const catalog: readonly CatalogItem[] = [
  ...
  ["Digital Air Fryer", "EC-HOME-011", 78000, 11, "Countertop air fryer with digital controls for quick, low-oil meals.", "1585515320310-259814833e31", "cat-home-living"],
  ...
  ["Non-Stick Pot Set", "EC-KITCH-013", 115000, 8, "Multi-piece non-stick cookware set for daily family cooking.", "1584990347449-ae7c2b0b9d4a", "cat-home"],
  ...
  ["Six-Piece Travel Box Set", "EC-STORE-017", 95000, 7, "Stackable travel box set with wheels and secure handles for every trip.", "1581553680321-4ff5b2f4e11b", "cat-home-living"],
