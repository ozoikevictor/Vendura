...
export const ORDER_STATUS_LABEL: Record<OrderStatus, string> = {
  ...
  delivered: "Delivered",
  awaiting_delivery_confirmation: "Awaiting Confirmation",
...
const timelineUpTo = (status: OrderStatus, startDaysAgo: number) => {
  ...
  const steps =
    status === "cancelled" ? ["placed" as OrderStatus] : ORDER_STATUS_FLOW.slice(0, idx + 1);
...
export const orders: Order[] = [
  {
    id: "ord-1",
    orderNumber: "VND-240917-8821",
    customerId: "user-cust-1",
    customerName: "Chibuike Okafor",
    ...
    items: [
      {
        id: "oi-1",
        productId: "p-aurora-5g",
        productName: "Aurora 5G Smartphone · 256GB · Dual SIM",
        productImage: productImages.phone,
        variantLabel: "Graphite / 256GB",
        quantity: 1,
        unitPrice: 232000,
        negotiated: true,
        subtotal: 232000,
      ...
      {
        id: "oi-2",
        productId: "p-nova-buds",
        productName: "Nova ANC Wireless Earbuds",
        productImage: productImages.earbuds,
        variantLabel: "White",
        quantity: 1,
        unitPrice: 32500,
        subtotal: 32500,
    ...
    trackingNumber: "TRK-LAG-55621",
    timeline: timelineUpTo("out_for_delivery", 4),
    placedAt: daysAgo(4),
    estimatedDelivery: daysFromNow(0),
  },
  {
    id: "ord-2",
    orderNumber: "VND-240912-7710",
    customerId: "user-cust-1",
    customerName: "Chibuike Okafor",
    customerPhone: "+234 812 345 6789",
    storeId: "store-stride",
    storeName: "Stride Lagos",
    items: [
      {
        id: "oi-3",
        productId: "p-vela-run",
        productName: "Vela Cloud Run Sneakers · Cream",
        productImage: productImages.sneakers,
        variantLabel: "Size 43",
        quantity: 1,
        unitPrice: 38500,
        subtotal: 38500,
      },
    ...
    deliveryAddress: addr,
    deliveryMethod: "Standard delivery",
    trackingNumber: "TRK-LAG-55102",
    timeline: timelineUpTo("delivered", 9),
    placedAt: daysAgo(9),
    estimatedDelivery: daysAgo(5),
  },
  {
    id: "ord-3",
    orderNumber: "VND-240916-9034",
    customerId: "user-cust-1",
    customerName: "Chibuike Okafor",
    customerPhone: "+234 812 345 6789",
    storeId: "store-homekraft",
    storeName: "HomeKraft",
    items: [
      {
        id: "oi-4",
        productId: "p-chefline-skillet",
        productName: "Chefline Cast Iron Skillet · 26cm",
        productImage: productImages.skillet,
        variantLabel: "26cm",
        quantity: 2,
        unitPrice: 28750,
        subtotal: 57500,
    ...
    timeline: timelineUpTo("processing", 1),
    placedAt: daysAgo(1),
    estimatedDelivery: daysFromNow(2),
  },
  {
    id: "ord-4",
    orderNumber: "VND-240830-4412",
    customerId: "user-cust-1",
    customerName: "Chibuike Okafor",
    customerPhone: "+234 812 345 6789",
    storeId: "store-essence",
    storeName: "Essence Co.",
    items: [
      {
        id: "oi-5",
        productId: "p-zaria-noir",
        productName: "Zaria Noir Eau de Parfum · 100ml",
        productImage: productImages.perfume,
        variantLabel: "100ml",
        quantity: 1,
        unitPrice: 45000,
        subtotal: 45000,
    ...
    deliveryAddress: addr,
    deliveryMethod: "Standard delivery",
    timeline: timelineUpTo("cancelled", 18),
    placedAt: daysAgo(18),
  },
  {
    id: "ord-5",
    orderNumber: "VND-240917-9102",
    customerId: "user-cust-1",
    customerName: "Chibuike Okafor",
    customerPhone: "+234 812 345 6789",
    ...
    items: [
      {
        id: "oi-6",
        productId: "p-basmati-10kg",
        productName: "Premium Long Grain Basmati Rice · 10kg",
    ...
    timeline: timelineUpTo("placed", 0),
...
const vendorItems = [
  {
    productId: "p-aurora-5g",
    name: "Aurora 5G Smartphone · 256GB · Dual SIM",
  ...
  {
    productId: "p-nova-buds",
    name: "Nova ANC Wireless Earbuds",
    image: productImages.earbuds,
    price: 32500,
    variant: "Black",
  },
  {
    productId: "p-zenbook-14",
    name: 'ZenBook 14" Ultrabook · Core i7',
  ...
  {
    productId: "p-chronos-watch",
    name: "Chronos Steel Automatic Watch · 40mm",
...
export const vendorOrders: Order[] = statuses.map((status, i) => {
  ...
  const order: Order = {
    ...
    deliveryAddress: {
      ...
      fullName: c[1],
      phone: c[2],
      city: ["Ikeja", "Lekki", "Wuse", "Enugu", "Kano"][i % 5]!,
      state: ["Lagos", "Lagos", "FCT", "Enugu", "Kano"][i % 5]!,
    },
...
function buildEscrow(order: Order): Escrow {
  if (order.paymentStatus === "refunded" || order.status === "cancelled") {
    return {
      status: "refunded",
      amount: order.total,
      fundedAt: order.placedAt,
      releasedAt: daysAgo(0, 6),
    };
  }
  ...
  if (order.status === "delivered") {
    ...
    return {
      ...
      amount: order.total,
      fundedAt: order.placedAt,
      autoReleaseAt: auto.toISOString(),
    };
  }
