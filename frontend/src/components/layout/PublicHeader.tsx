...
export function PublicHeader() {
  ...
  return (
    <>
    <header className={`fixed inset-x-0 top-0 z-40 border-b border-primary/20 bg-[#edf8f0] transition-shadow duration-300 ${scrolled ? "shadow-[0_10px_28px_-16px_rgba(35,44,38,0.45)]" : "shadow-sm"}`}>
