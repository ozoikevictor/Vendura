  ...
  return (
    <CustomerAIGuard>
      <div className="flex h-screen flex-col overflow-hidden bg-background">
        <MarketplaceHeader />
        <main className="mx-auto flex min-h-0 w-full max-w-7xl flex-1 gap-0 overflow-hidden px-0 sm:px-6 sm:py-6 lg:px-8">
          ...
          <section className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden bg-card sm:rounded-r-lg sm:border">
            <header className="flex h-16 items-center gap-3 border-b border-border px-4">
              <Link to="/marketplace" aria-label="Back to marketplace" className="sm:hidden">
              ...
              <div>
                <h1 className="text-base font-bold">AI Shopping Assistant</h1>
              ...
              {!message ? (
                <div className="mx-auto flex max-w-3xl flex-col items-center py-8 text-center sm:py-16">
                  ...
                  <h2 className="mt-5 text-2xl font-bold">
                    Hi {user?.fullName.split(" ")[0] ?? "there"}, what are you looking for today?
                  </h2>
                  <p className="mt-2 text-sm text-muted-foreground">
                    Describe the product, budget, condition, or delivery date you need.
                  </p>
                  <div className="mt-8 grid w-full gap-2 sm:grid-cols-2">
                    {prompts.map((prompt) => (
                      <button
                        ...
                        className="min-h-16 rounded-md border border-border bg-background p-3 text-left text-sm font-medium transition-colors hover:border-primary hover:bg-primary-soft"
                      >
                        {prompt}
                      </button>
                    ))}
                ...
                <div className="mx-auto max-w-3xl space-y-5">
                  <div className="ml-auto max-w-[85%] rounded-lg bg-primary px-4 py-3 text-sm text-primary-foreground">
                    {message}
                  </div>
                  {loading ? (
                    <Typing />
                    ...
                    <>
                      ...
                      <div className="rounded-lg border border-dashed border-primary/40 bg-primary-soft p-4">
            ...
            <form
              ...
              className="sticky bottom-0 border-t border-border bg-card p-3 sm:p-4"
            >
